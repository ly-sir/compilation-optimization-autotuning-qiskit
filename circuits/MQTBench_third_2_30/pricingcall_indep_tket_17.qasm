...
cx q[9],q[8];
ccx q[5],q[14],q[15];
u3(0.09366343673910417*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
x q[14];
ccx q[4],q[13],q[14];
u3(3.9063365632608957*pi,0.0*pi,0.0*pi) q[8];
u1(0.0*pi) q[9];
x q[4];
u1(0.0*pi) q[8];
x q[13];
...
cx q[9],q[8];
ccx q[2],q[11],q[12];
u3(3.9995712481632566*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
x q[11];
ccx q[1],q[10],q[11];
u3(0.00042875183674334085*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[0],q[8];
x q[1];
x q[10];
u1(0.0*pi) q[8];
...
u1(0.0*pi) q[9];
cx q[9],q[8];
u3(3.999142496326513*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
u3(0.000857503673486685*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[1],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
...
cx q[9],q[8];
x q[1];
u3(3.998284992653027*pi,0.0*pi,0.0*pi) q[8];
x q[10];
x q[11];
x q[1];
cx q[9],q[8];
x q[10];
u3(0.0017150073469733669*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[2],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
...
u1(0.0*pi) q[9];
cx q[9],q[8];
u3(3.9965699853060532*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
u3(0.0034300146939467337*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[3],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
...
cx q[9],q[8];
x q[13];
u3(3.9931399706121065*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
u3(0.0068600293878934675*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[4],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
...
cx q[9],q[8];
x q[4];
u3(3.986279941224213*pi,0.0*pi,0.0*pi) q[8];
x q[13];
x q[14];
x q[4];
cx q[9],q[8];
x q[13];
u3(0.013720058775786935*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[5],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
...
u1(0.0*pi) q[9];
cx q[9],q[8];
u3(3.9725598824484263*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
u3(0.02744011755157387*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[6],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
...
cx q[9],q[8];
x q[16];
u3(3.945119764896852*pi,0.0*pi,0.0*pi) q[8];
cx q[9],q[8];
u3(0.054880235103147865*pi,0.0*pi,0.0*pi) q[8];
ccx q[9],q[7],q[8];
u1(0.0*pi) q[8];
u1(0.0*pi) q[9];
cx q[9],q[8];
