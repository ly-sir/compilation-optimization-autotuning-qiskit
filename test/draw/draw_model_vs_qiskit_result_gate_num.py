...
def get_data(train=False, test=False, third=False, big=False):
    ...
    ##################################################################################################################################
    if big:
        a_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/model_all_MQT_2_30_circuits_result_31_40.txt"
        b_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/qiskit_all_MQT_2_30_circuits_result_31_40.txt"
    if test:
        a_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/model_all_MQT_2_30_test_circuits_result.txt"
        b_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/qiskit_all_MQT_2_30_test_circuits_result.txt"
        
    if train:
        a_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/model_all_MQT_2_30_train_circuits_result.txt"
        b_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/qiskit_all_MQT_2_30_train_circuits_result.txt"

    if third:
        a_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/model_test_circuits_result_third.txt"
        b_result = "../data/opt_rate/node_gate_num/"+ param_set +"/_"+ str(n) +"/qiskit_test_circuits_result_third.txt"
...
def get_increase_rate_data(algorithm_names, before_a, after_a, before_b, after_b):
    ...
    # 匹配模型和 Qiskit 结果
    performance_dict_a = defaultdict(int)  # 使用 defaultdict 以避免 KeyError
    performance_dict_b = defaultdict(int)
...
def depth_():
    ...
    # 设置图表标题
    axs.set_title('Agent vs Qiskit -O3 (Circuit Depth)')
